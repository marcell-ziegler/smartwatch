...
// Upstream Adafruit_GFX.h pulls in Adafruit_I2CDevice.h / Adafruit_SPIDevice.h
// here for the SPITFT/GrayOLED subclasses that ship in the same library.
// This vendored copy is base Adafruit_GFX only (what PCDisplay subclasses),
// so those two BusIO headers are dropped rather than shimmed.
